...
export default function QuizApp(){
 ...
 return <QuestionCard unit={unit} question={activeQuestion} current={currentIndex+1} total={questions.length} selectedIndex={storedAnswer?.selectedIndex} onSelect={recordAnswer} onPrev={goPrev} onNext={goNext} canPrev={currentIndex>0}/>;
}
